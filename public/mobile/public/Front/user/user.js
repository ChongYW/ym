...
function nowToMoney(){
    ...
    if(amountPay == ""){
        ...
        $("#nowToMoneyBtn").attr({'onClick':'javascript:','style':'background:#cccccc'}).text("正在提交");
        $.ajax({
            type : "POST",
            url : "/user/nowToMoney",
            dataType : "json",
                   ...
                   // alert(data.msg);
                    ...
                    layer.open({
                        ...
                        yes: function(index){
                            ...
                            $("#nowToMoneyBtn").attr({'onClick':'javascript:nowToMoney();','style':'background:#3579f7'}).text("立即投资");
                        }
                    });
                }
            }
