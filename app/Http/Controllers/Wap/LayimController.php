...
class LayimController extends BaseController
{
    ...
    public function __construct(Request $request)
    {
        ...
        if(Cache::has('wap.category')){
            ...
            $footcategory= DB::table('category')->whereRaw("FIND_IN_SET(?,templates)",Cache::get("WapTemplate"))->where("atfoot","1")->orderBy("sort","desc")->limit(5)->get();
    ...
    public function index(Request $request){
        ...
        return $this->WapShowTemplate("layim.kefuadmin");
    ...
    public function kefu(Request $request){
        ...
        if($UserId>0){
            return $this->WapShowTemplate("layim.kefu");
        }else{
            return $this->WapShowTemplate("layim.ykkefu");
        }
