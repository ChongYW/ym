...
class LayimController extends BaseController
{
    ...
    public function send(Request $request){
       ...
       $picImg= Member::where('id',$request->id)->value('picImg');
        ...
        //$data['avatar'] =$picImg!=''?$picImg:'/layim/images/avatar/1.jpg';
    ...
    public function chatlog(Request $request){
        ...
        if($layimdatas){
            ...
            foreach($layimdatas as $k=>$layims){
                ...
                if($layims->fromuid>0){
                    $picImg= Member::where('id',$layims->fromuid)->value('picImg');
                    $msg[$k]['avatar']=$picImg!=''?$picImg:asset("layim/images/avatar/".($layims->fromuid%10).".jpg");
                }else{
                    $picImg= Admin::where('id',-$layims->fromuid)->value('img');
                    $msg[$k]['avatar']=$picImg!=''?$picImg:asset("layim/images/avatar/kf.png");
                }
