...
class Category extends Model
{
    ...
    protected $guarded=[];
    protected $fillable = ['name','parent','sort','siteid','thumb_url','model','color','ctitle','ckeywords','cdescription','ccontent','atindex','isshow','morec','click_count','atfoot','ismenus','classname','links','templates'];
    protected $tree;
    ...
    public function tree_option($parentid=0,$cj=0,$selected=0,$current=0,$model='')
    {
        ...
        if($model!=''){
            $category =Category::where('parent',$parentid)->where('model',$model)->orderBy("sort","desc")->get();
        }else{
