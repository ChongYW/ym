            ...
            <div class="w1190 fn_cle">
                ...
                <div class="top_rig fn_rig">
                    ...
                    <div class="login_reg" style="margin-top:0px;">
                        @if(isset($Member))
                            <a href="{{route('user.index')}}" class="link1" target="_top" style="color:#ffffff;">管理中心</a>
                            <a href="javascript:qiandao();" class="link2" target="_top" style="color:#fff">签到</a>
                            <a href="{{route('pc.loginout')}}" class="link2" target="_top" style="color:#fff">退出</a>
                        @else
                            <a href="{{route('pc.login')}}" class="link1" target="_top" style="color:#ffffff;">登录</a>
                            <a href="{{route('pc.register')}}" class="link2" target="_top" style="color:#fff">注册</a>
                        @endif
    ...
    <div id="right_tool" style="right: 11.5px; display: block;">
        <ul>
            @if(Cache::get('WebIMKeFu')!='开启')
                <li><a href="{{$kefulinks}}" target="_blank" class="kefu1" id="qqonlin"><span>在线<br>客服</span></a></li>
            @endif
...
/*            $(window).scroll(function(){
    ...
    <div class="footer" style="min-width:1200px;">
        <div class="w1100">
            <ul>
                <li>
                    <a target="_blank" href="{{route("singlepages.links",["links"=>"about"])}}" class="til">关于我们</a>
                    <a target="_blank" href="{{route("singlepages.links",["links"=>"about"])}}">关于我们</a>
                    <a href="{{route("singlepages.links",["links"=>"about"])}}" target="_blank">公司简介</a>
                    <a href="{{route("singlepages.links",["links"=>"gszz"])}}" target="_blank">公司资质</a>
                    <a href="{{route("singlepages.links",["links"=>"zjwt"])}}" target="_blank">常见问题</a>

                </li>
                <li>
                    <a target="_blank" href="{{route("singlepages.links",["links"=>"about"])}}" class="til">帮助中心</a>
                    <a href="{{route("singlepages.links",["links"=>"zffs"])}}" target="_blank">支付方式</a>
                    <a href="{{route("singlepages.links",["links"=>"aqbz"])}}" target="_blank">安全保障</a>
                    <a href="{{route("singlepages.links",["links"=>"hqhy"])}}" target="_blank">邀请好友</a>
                    <a href="{{route("singlepages.links",["links"=>"hydj"])}}" target="_blank">会员等级</a>

                </li>
                <li>
                    <a target="_blank" href="{{route("singlepages.links",["links"=>"xinshou"])}}" class="til">新手指引</a>
                    <a target="_blank" href="{{route("products.links",["links"=>"xinshou"])}}">新手指引</a>
                    <a href="{{route("products.links",["links"=>"vip"])}}" target="_blank">VIP专区</a>
                    <a href="{{route("products")}}" target="_blank">投资项目</a>
                    <a href="{{route("singlepages.links",["links"=>"wxzxkf"])}}" target="_blank">在线客服</a>
                </li>
        ...
        <div class="f" style="line-height:220%; background:#2F2F2F; width:100%; text-align:center; color:#FFF">
            ...
            <p>Copyright© 2016 njssth.com All Rights Reserved {{Cache::get('CompanyShort')}}</p>
            <br>
            <a target="_blank" href="/"><img alt="" src="/pc/finance/css/images/1.png" width="105" height="35"></a>
            <a target="_blank" href="/"><img alt="" src="/pc/finance/css/images/2.png" width="105" height="35"></a>
            <a target="_blank" href="/"><img alt="" src="/pc/finance/css/images/3.png" width="105" height="35"></a>
            <a target="_blank" href="/"><img alt="" src="/pc/finance/css/images/4.png" width="105" height="35"></a>
            <a target="_blank" href="/"><img alt="" src="/pc/finance/css/images/5.png" width="105" height="35"></a>
            <a target="_blank" href="/"><img alt="" src="/pc/finance/css/images/6.png" width="105" height="35"></a>
            <a target="_blank" href="/"><img alt="" src="/pc/finance/css/images/5.gif" width="105" height="35"></a>
            <a target="_blank" href="/"><img alt="" src="/pc/finance/css/images/6.gif" width="105" height="35"></a><br>
        </div>
    </div>
    ...
    <div class="floating_ckcc">
        <a href="{{route('user.lotterys')}}" target="_blank"><img src="/pc/finance/jsonpublic/images/toolbar-partner.gif" width="80"></a>
    </div>
