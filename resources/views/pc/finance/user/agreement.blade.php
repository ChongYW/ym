...
<div class="wrap">
    <div class="ylb-text">
        ...
        <p>既乙方通过由甲方运营管理的<?php echo \Cache::get('CompanyLong'); ?>平台（域名:<?php echo \Cache::get('domain'); ?>，“<?php echo \Cache::get('CompanyLong'); ?>”）进行其公司运营操作的产品项目投资意愿、双方根据平等、自愿的原则，达成本协议如下：</p>
        ...
        <p>（1）甲方、乙方、丙方在本协议（含传真件）上签字盖章、且乙方通过<?php echo \Cache::get('CompanyLong'); ?>以网络在线点击：立即投资的方式签订；<br/>
        ...
        <p>7.3 三方均确认，本协议的签订、生效和履行以不违反法律为前提。如果本协议中的任何一条或多条违反适用的法律，则该条将被视为无效，但该无效条款并不影响本协议其他条款的效力。</p>
