    ...
    <div class="w1200">
                ...
                <div class="clearfix">
                    ...
                    <div class="r-user-border white-bg bfc">
                        <ul class="user-tabs-menu clearfix" current="2">
                            <li class="selected"><a href="{{route('user.tender')}}">投资记录</a></li>
        ...
        <script id="demo" type="text/html">
            ...
            <tr class="noInfo">
                ...
                <td><% item.useritem_time2 %></td>
                <td><% item.redshouyi %></td>
                <td><% item.wredshouyi %></td>

                <td><% item.status==0?'结束':'进行中' %></td>
