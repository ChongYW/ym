...
<style>
    ...
    .zfpz { max-width:100px;}
            ...
            <tbody id="view">
                 ...
                 <tr>
                     <th colspan="2">当前总计</th>

                     <th id="pageamounts" colspan="2">0</th>
                     <th colspan="2">总计</th>
                     <th id="amounts" colspan="2">0</th>
                     <th colspan="2">收益总计</th>
                     <th id="syamounts" colspan="3">0</th>
...
@section('form')
    ...
    <script id="demo" type="text/html">
        ...
        <tr>
            ...
            <td><% item.pay_codename %></td>
              <td><a href="<% item.img %>" target="_blank"><img class="zfpz" src="<% item.img %>"></a></td>
            <td><% item.memo %></td>
            ...
            <td class="td-manage">
                ...
                <%# if(item.status==1){ %>
                <%# if(item.sendsms==0){ %>
                <a title="发送短信"  onclick="sendsms(<% item.id %>,<% d.current_page %>,'<% item.memo %>')" href="javascript:;">
                    <i class="layui-icon" style="color: green;font-size: 16px;">&#xe609;</i>
                </a>
                <%# }else if(item.status==1){ %>
                <a title="重新发送短信"  onclick="sendsms(<% item.id %>,<% d.current_page %>,'<% item.memo %>')" href="javascript:;">
