...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <label class="layui-form-label col-sm-1">充值帐号</label>

        <div class="layui-input-inline">

            <input type="text" name="username" lay-verify="required" class="layui-input" placeholder="充值帐号" value="">
...
-->
    ...
    <div class="layui-form-item">
        ...
        <label class="layui-form-label col-sm-1">是否短信通知</label>

        <div class="layui-col-md4">

            <input type="checkbox" value="tongzhi" name="sendmoblile" title="发送短信">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md4">
            ...
            <textarea name="memo" placeholder="备注说明(短信通知内容)" class="layui-textarea" ></textarea>
        </div>
