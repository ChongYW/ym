    ...
    <script id="demo" type="text/html">
            ...
            <tr>
                ...
                <td>
                    ...
                    <%# if(item.status==1){ %>
                    <input type="checkbox"   lay-skin="switch" lay-filter="switchTest-settop" lay-text="未读|已读" id="<% item.id %>">
                    <%# }else{ %>
                    <input type="checkbox"    checked  lay-skin="switch" lay-filter="switchTest-settop" lay-text="未读|已读" id="<% item.id %>">
