...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="sort" placeholder="项目排序" autocomplete="off" class="layui-input" lay-verify="required" value="1">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md3">
            <input type="text" name="zsid" lay-verify="required" required placeholder="赠送项目id" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md3">
            <input type="text" name="zsje" lay-verify="required" required placeholder="赠送项目金额" autocomplete="off" class="layui-input" value="">
        </div>
    </div>   
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md3">
            <input type="text" name="shorttitle"  placeholder="项目副标题" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md3">
            <input type="text" name="bljg" placeholder="保理机构" lay-verify="required" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="ketouinfo" placeholder="可投金额提示" lay-verify="required" autocomplete="off" class="layui-input" >
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="xmjd" placeholder="投资进度" lay-verify="required" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="qtje" placeholder="起投金额" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="tzrs" placeholder="投资人数:x人" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="hkfs">
                <option value="0" selected="selected">按天付收益，到期还本</option>
                <option value="3">按天付收益，等额本息返还</option>
                <option value="2">按小时付收益，到期还本</option>
                <option value="1">到期还本,到期付息</option>
                <option value="4">每日复利,保本保息</option>
                
                    <option value="5">5天付收益，到期还本</option>
                    <option value="10">10天付收益，到期还本</option>
                    <option value="30">30天付收益，到期还本</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="isft">
                <option value="0" selected="selected">不能复投</option>
                <option value="1">可以复投</option>
            </select>
        </div>
        ...
        <div class="layui-input-inline">
            <input type="number" name="futoucishu" placeholder="复投限制次数" autocomplete="off" class="layui-input" value="1" style="width: 70%">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="jyrsy" placeholder="交易收益: x%" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="xxtc" lay-filter="xxtc">
                <option value="0"  selected="selected">系统提成比例</option>
                <option value="1" >自定义提成比例</option>
            </select>
        </div>
    ...
    @foreach($Memberticheng as $ticheng)
        <div class="layui-form-item xxtcblBox"  style="display: none;">
            <label class="layui-form-label layui-input-inline">{{$ticheng->name}}提成(%)</label>
            <div class="layui-input-inline">
                <input type="text" name="xxtcbl[{{$ticheng->id}}]" placeholder="{{$ticheng->name}}提成" autocomplete="off" class="layui-input" value="0" >
            </div>
        </div>
    @endforeach
    ...
    <div class="layui-form-item ">
        ...
        <div class="buydataList">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" name="buydata[0]" placeholder="最小购买数" autocomplete="off" class="layui-input buydata"  style="width: 80%;float: left;" lay-verify="required">
            </div>

            <div class="layui-input-inline">
                <label class="layui-form-label col-sm-1">最大购买数</label>
                <input type="text" name="buydata[1]" placeholder="最大购买数" autocomplete="off" class="layui-input buydata"  style="width: 80%;float: left;" lay-verify="required">
            </div>

            <div class="layui-input-inline">
                <label class="layui-form-label col-sm-1">基数位数</label>
                <input type="text" name="buydata[2]" placeholder="基数位数" autocomplete="off" class="layui-input buydata"  style="width: 80%;float: left;" lay-verify="required">
            </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="shijian" placeholder="项目期限" autocomplete="off" class="layui-input" value="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="isaouttm">
                <option value="0" selected="selected" >关闭自动投满</option>
                <option value="1">开启自动投满</option>
            </select>
        </div>

        <div class="layui-input-inline">
            <input type="text" name="endingtime" placeholder="到期时间" autocomplete="off" class="layui-input" id="endingtime" value="">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="tzzt" lay-filter="tzzts">
                <option value="0" selected="selected">投资中</option>
    ...
    <div class="layui-form-item tzzts" style="display: none">
        <label class="layui-form-label col-sm-1">倒计时广告</label>


        <div class="layui-input-block">
            <input type="text" name="countdownad" placeholder="倒计时广告" autocomplete="off" class="layui-input" id="countdownad" >
        </div>
    </div>
    ...
    <div class="layui-form-item tzzts" style="display: none">
        ...
        <div class="layui-input-inline">
            <input type="text" name="countdown" placeholder="购买倒计时" autocomplete="off" class="layui-input" id="countdown" >
        </div>
    </div>
...
/*
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md6">
            ...
            <input type="text" name="insuranceseal"  value="" class="layui-input thumb2" placeholder="保险公章图片" style="float:left;width:50%;">
        ...
        <div class="layui-input-block" style="height: 30px;">
            ...
            @if($Coupons)
                @foreach($Coupons as $v)
                    @if($v->type==1)
                        <input type="checkbox" value="{{$v->id}}" name="coupon[]" title="{{$v->name}}" lay-skin="primary" >
                    @endif
                @endforeach
            @endif
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="wzone" placeholder="文字1" autocomplete="off" class="layui-input" value="">
        </div>
        <div class="layui-input-inline">
            <input type="text" name="wztwo" placeholder="文字2" autocomplete="off" class="layui-input" value="">
        </div>
        <div class="layui-input-inline">
            <input type="text" name="wzthree" placeholder="文字3" autocomplete="off" class="layui-input" value="">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="tagcolor" placeholder="图片文字样式" autocomplete="off" class="layui-input" value="">
        </div>
