        ...
        <div class="layui-row">
            <form class="layui-form layui-col-md12 x-so" action="{{ route($RouteController.".lists") }}" method="get">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="hidden" name="s_status"  placeholder="请输入邀请人ID" autocomplete="off" class="layui-input s_status" value="@if(isset($_REQUEST['s_status'])){{$_REQUEST['s_status']}}@endif">
