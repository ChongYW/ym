...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <input type="text" name="rate"   lay-verify="required" class="layui-input" placeholder="充值奖励利率:%" value="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="wheels"  class="layui-input " placeholder="每日玩转次数" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="djfy"  class="layui-input " placeholder="百分比" >
