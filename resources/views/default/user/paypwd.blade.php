        ...
        <div class="box" >
            <div class="tagMenu">
                <ul class="menu">
                    ...
                    <li class="current"><a href="{{route("user.paypwd")}}">修改交易密码</a></li>
        ...
        <div class="myinfo" style="padding:5px  10px; margin-bottom: 15px;background:#fff;">
            ...
            <form action="/mobile/action/user.php?action=bank" method="post" class="layui-form">
                <table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" style="margin-top:10px;" height="90">
                    ...
                    <tr height="60">
                        <td style="background:#F9F9F9;border-bottom:#e6e6e6 solid 1px;border-left:#e6e6e6 solid 1px;border-right:#e6e6e6 solid 1px;" align="right">原始交易密码：</td>
