    ...
    <div class="login_bg">
        ...
        <form action="" method="post">
                <div class="input_text cert">
                    <label>姓名</label>
                    <input type="text" name="realname" id="realname" placeholder="输入姓名" value="{{$Member->realname}}">
                </div>
                ...
                <div class="input_text cert">
                    <label>身份证号码</label>
                    <input type="text" name="card" id="identy" placeholder="输入有效身份证号" value="{{$Member->card}}">
                </div>

                @if($Member->card=='')
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                <input type="button" class="input_btn" value="立即认证" onclick="SubForm()"/>
                @endif
            </form>
