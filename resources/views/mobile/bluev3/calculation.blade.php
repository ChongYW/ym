...
@section('body')
    <div class="othertop">
        ...
        <div class="othertop-font">收益计算器</div>
    </div>
    <style type="text/css">
        .c_calculatorCpmLeft{padding: 36px 0 0 36px;}
        .c_calculatorCpmRight ul.c_cpmscroll{width: 100%;}
        .c_calculatorCpmRight ul dd, .c_calculatorCpmRight ul dl.c_dd_titlecpm dd{width: 19%;font-size: 12px;}
        .c_libottomcpm{width: 100%;}
        .c_calculator_all {
            width: 100%;
        }
    ...
    <div style="width: 100%;border-top: 1px solid #e7e7e7;background-color: #f4f7f8;">
