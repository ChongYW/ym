...
@section('body')
    ...
    <div class="user_zx_right" >
        <div class="box" >
            <div class="tagMenu">
                <ul class="menu">
                    ...
                    <li class="current"><a href="{{route("user.password")}}">修改登录密码</a></li>
        ...
        <div class="myinfo" style="padding:5px  10px; margin-bottom: 15px;background:#fff;">
            ...
            <p style="margin-:15px;">您可以通过经常性修改登录密码更好的保护您的账号安全，以避免您受到意外损失</p>
            <p style="margin-:15px;">1、经常性修改登录密码能有效的保护您的帐号安全</p>
            <p style="margin-:15px;">2、涉及到您的资金安全，请勿设置简单的登录密码，不要设置和其它网站相同的登录密码</p>
            ...
            <form action="/mobile/action/user.php?action=bank" method="post" class="layui-form">
                <table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" style="margin-top:10px;" height="90">
                    ...
                    <tr height="60">
                        <td style="background:#F9F9F9;border-bottom:#e6e6e6 solid 1px;border-left:#e6e6e6 solid 1px;border-right:#e6e6e6 solid 1px;" align="right">原始登录密码：</td>
                        <td style="border-right:#e6e6e6 solid 1px;border-bottom:#e6e6e6 solid 1px; padding-left:5px;"><input type="password" name="pass" id="pass" style="width:200px; height:30px; line-height:30px; border-radius: 15px; border:#CCCCCC solid 1px; padding:0px 8px;"></td>
                    </tr>
                    <tr height="60">
                        <td style="background:#F9F9F9;border-bottom:#e6e6e6 solid 1px;border-left:#e6e6e6 solid 1px;border-right:#e6e6e6 solid 1px;" align="right">新登录密码：</td>
                    ...
                    <tr height="60">
                        <td style="background:#F9F9F9;border-bottom:#e6e6e6 solid 1px;border-left:#e6e6e6 solid 1px;border-right:#e6e6e6 solid 1px;" align="right">请再输入新密码：</td>
                    ...
                    <tr height="50">
                        ...
                        <td style="border-right:#e6e6e6 solid 1px;border-bottom:#e6e6e6 solid 1px; color:#ff9600; padding-left:3px;">  <input type="button" value="提交" class="btnsubupdate" onclick="SubForm()"> <input type="button" value="&nbsp;&nbsp;取消&nbsp;&nbsp;" class="btncancel" onClick="location.href=location.href;" id="btn_cancel"></td>
                    </tr>
                    </tbody></table>
