        ...
        <div class="box" >
            <div class="tagMenu">
                <ul class="menu">
                    ...
                    <li class="current"><a href="{{route("user.shiming")}}">实名认证</a></li>
            ...
            <form action="" method="post" id="edit">
                <table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" style="margin-top:10px;" height="90">
                    ...
                    <tr height="50">
                        ...
                        <td style="border-right:#e6e6e6 solid 1px;border-bottom:#e6e6e6 solid 1px; color:#ff9600; padding-left:3px;">  <input type="button" value="@if($Member->card=='')实名认证@else认证成功@endif" class="btnsubupdate" @if($Member->card=='')onclick="SubForm('edit')"@else onclick="alert('认证成功')"@endif> <input type="button" value="&nbsp;&nbsp;取消&nbsp;&nbsp;" class="btncancel" onClick="location.href=location.href;" id="btn_cancel"></td>
                    </tr>
                    </tbody>
                </table>
