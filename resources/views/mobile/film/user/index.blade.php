 ...
 **/
    ...
    <div class="userinfo nx-userinfo2">
        ...
        <span style="width:195px;   left: 60px;position: absolute;top: 38px;">
            ...
            <a href="{{route("user.msglist")}}"><img src="{{asset("mobile/film/images/home_message_icon.png")}}" id="top_msg" style="position: absolute;z-index: 9;right: 5px;top: 60px;width: 11%;" ></a>
            ...
            <div class="details nx-details">
                ...
                <ul class="details_r">
                    ...
                    <font style="font-family:'Bebas';">
                      <?php echo $Member->yuamount; ?>                  </font>
                <p>
                    <font style="font-family:'Bebas';">余额宝资产(元)</font>
                </p>
            </span></li>
                </ul>
            </div>
...
{{--
                ...
                <a href="{{route("user.tender")}}">
                    ...
                    <div class="hui-list-text">
                        ...
                        <div class="hui-list-info" style="">
                            累计投资<font style="color:#f95a5a;font-size: 13px; ">{{$buyjscounts}}</font>笔 <span class="hui-icons hui-icons-right"></span>
                        </div>
                    </div>
                </a>
            </li>
    ...
    <div class="hui-list" style="margin-top:10px;">
        ...
        <ul>
            ...
            <li>
                <a href="{{route("user.offline.budget")}}">
                    <div class="hui-list-icons">
                        <img src="{{asset("mobile/film/images/touzi_icon.png")}}">
                    </div>
                    <div class="hui-list-text">
            ...
            <li>
                <a href="{{route("singlepage",["links"=>"gszz"])}}">
                    <div class="hui-list-icons">
                        <img src="{{asset("mobile/film/images/index-hlf-icon6.png")}}">
                    </div>
                    <div class="hui-list-text">
                        公司资质
                        <div class="hui-list-info">
    ...
    <div style="padding:10px 20px;margin-bottom:20px;" id="btnList2">
