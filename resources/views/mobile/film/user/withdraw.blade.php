...
@section('body')
    ...
    <form action="" method="post" id="withdraw">
        ...
        <div class="formGroup" style="color:red;">{!! Cache::get('WithdrawExplain') !!}</div>
    ...
    <div class="formGroup"><span class="left">可提现额度</span> <span class="right">¥<?php echo $Member->amount; ?> 元</span> </div>
