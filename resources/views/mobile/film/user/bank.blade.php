...
@section('body')
    ...
    <div class="formGroup"><span class="left" onclick="$('#bankrealname').focus();">开户人姓名</span>

        <input name="bankrealname" class="right" id="bankrealname" value="{{$Member->realname}}" readonly type="text" style="width: 80%;"></div>
    ...
    <div class="formGroup">
        <span class="left" onclick="$('#bankcode').focus();">银行卡号</span>
        <input name="bankcode" id="bankcode" value="{{$Member->bankcode}}" type="text" class="right" style="width: 85%;">
    </div>



    <div class="formGroup">
        <span class="left" onclick="$('#bankaddress').focus();">开户银行</span>
        <input name="bankaddress" id="bankaddress" value="{{$Member->bankaddress}}" type="text" class="right" style="width: 85%;">
    </div>
